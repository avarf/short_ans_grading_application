...
\begin{itemize}
\item The model answers and student answers were  invloving tokenizing the words and convertion into lowercase form, stopword removal and Lemmatization to obtain the base / dictionary form of a word.
\end{itemize}
